...
#Use the nodegridcoin library to pull statistics from your Gridcoin node: https://github.com/grctest/node-gridcoin
#If you're going to use your node just for stats, you don't need to use SSL. If you're handling GRC through the node, use SSL.
